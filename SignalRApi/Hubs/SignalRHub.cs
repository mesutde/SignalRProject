...
namespace SignalRApi.Hubs
{
    public class SignalRHub : Hub
    {
        ...
        public SignalRHub(ICategoryService categoryService, IProductService productService, IOrderService orderService, IMoneyCaseService moneyCaseService, IMenuTableService menuTableService = null, IBookingService bookingService = null, INotificationService notificationService = null)
        {
        ...
        public async Task SendStatistic()
        {
            ...
            await Clients.All.SendAsync(method: "ReceiveActiveCategoryCount", value3);
            ...
            await Clients.All.SendAsync("ReceiveTotalOrderCount", value11.ToString("0.00") + " TL");
        ...
        public async Task SendProgress()
        {
            ...
            await Clients.All.SendAsync("ReceiveTotalMoneyCaseAmount", value.ToString(format: "0.00") + " TL");

            var value2 = _orderService.TActiveOrderCount();
            await Clients.All.SendAsync("ReceiveActiveOrderCount", value2);

            var value3 = _menuTableService.TMenuTableCount();
            await Clients.All.SendAsync("ReceiveMenuTableCountMenu", value3);
