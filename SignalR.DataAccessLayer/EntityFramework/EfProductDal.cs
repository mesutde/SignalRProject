    ...
    public class EfProductDal : GenericRepository<Product>, IProductDal
    {
        ...
        public int ProductCountByCategoryNameHamburger()
        {
            ...
            return context.Products.Where(x => x.CategoryID ==
                (context.Categories.Where(y => y.CategoryName == "Hamburger").Select(z => x.CategoryID).FirstOrDefault())).Count();
        }
        ...
        {
            using var context = new SignalRContext();
            return context.Products.Where(x => x.ProductName == "Stack Burger").Select(y => y.Price).FirstOrDefault();
        }
